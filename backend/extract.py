...
SYSTEM_PROMPT = (
    ...
    "\"gov\" (policy, governance, government), "
    "\"ops\" (operations, field-building, community-building, program/event management, "
    "recruiting, communications, org-building), \"other\" — multiple allowed when a role "
    "spans more than one. "
